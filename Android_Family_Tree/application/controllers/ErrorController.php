...
require_once '../../Android_Family_Tree/application/controllers/OrderpageController.php';
...
class ErrorController extends Zend_Controller_Action {
    ...
    public function errorAction() {
        ...
        //ログファイルに出力
        $sendLogFile = "../../Android_Family_Tree/FamilyTreeLog/send_log_" . date("Ymd", time()) . ".txt";
        clearstatcache();
