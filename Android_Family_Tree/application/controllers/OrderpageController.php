...
require_once '../../Android_Family_Tree/application/models/orderpageModel.php';
require_once '../../Android_Family_Tree/application/smarty/Zend_View_Smarty.class.php';
require_once '../../Android_Family_Tree/application/common/comEncryption.php';
require_once '../../Android_Family_Tree/application/common/comConst.php';
require_once '../../Android_Family_Tree/application/common/common.php';
...
class OrderpageController extends Zend_Controller_Action {
    ...
    public function init() {
        /* ========== 設定情報を読み取り ========== */
        $this->_config = new Zend_Config_Ini('../../Android_Family_Tree/application/configs/application.ini', null);
...
/** ===============  　　　画像URL 　　　====================== */
    ...
    public function disAction(){
            ...
            readfile('../../Android_Family_Tree/CanNotBrowse.png');
    }
